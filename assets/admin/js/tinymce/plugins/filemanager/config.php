...
$base_url="http://isuzu-vietnam.com"; //url base of site if you want only relative url leave empty
$upload_dir = '/demo/uploads/assets/'; // path from base_url to upload base dir
$current_path = '../../../../../../uploads/assets/'; // relative path from filemanager folder to upload files folder
...
//Allowed extensions
//**********************
$ext_img = array('jpg', 'jpeg', 'png', 'gif', 'bmp', 'tiff', 'JPG', 'JPEG', 'PNG', 'GIF', 'BMP', 'TIFF'); //Images
