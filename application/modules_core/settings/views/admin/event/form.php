...
<form class="form-horizontal form-box" method="post" action="" />
	...
	<h4 class="form-box-header">Event Registration</h4>
	...
	<!-- event register -->
	<div class="control-group">
	<label class="control-label" for="reg_eventid"><?php echo $this->lang->line('reg_form_eventregister'); ?></label>
	<div class="controls">
	<input type="text" id="reg_eventid" name="event_id" style="width:400px;" class="input-xlarge" value="<?php if($regformobj->event_id <> 0) echo $this->admin_model_news->get_news_title($regformobj->event_id); ?>" disabled />
	</div>
	</div>
