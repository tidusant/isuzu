...
<li><a href="<?php echo site_url($this->uri->segment(1).'/filemanager/categal/index/'.$this->uri->segment(5));?>">Catalog Image Manage</a></li>
<li class="active"><a href="">Add Media</a></li>
</ul>

<h3>Media Uploading Form</h3>	
	
	<?php echo form_open_multipart(site_url($this->uri->segment(1).'/filemanager/categal/uploadimg/'), 'id="form_media"'); ?>
		
		<h4 class="form-box-header">Image File Upload</h4>
		<div class="form-box-content">
			<!-- form content -->
			<input type="hidden" name="dir_to_upload" value="<?php echo $cate_gal_info->created_folder;?>" />
			<input type="hidden" name="cat_gal" value="<?php echo $cate_gal_info->id;?>" />
			<br />
	...
	<p style="text-align:center;"><a href="<?php echo site_url($this->uri->segment(1).'/filemanager/categal/index/'.$this->uri->segment(5));?>">VIEW LIST</a></p>
